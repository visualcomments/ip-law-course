...
- предоставлять «синтетический корпус поправок» для офлайн-демо без внешних
  данных, в духе офлайн-режима top-papers-graph demo.
"""
...
class NormChunk:
    ...
    source_doc: str  # имя файла корпуса, e.g. txt/gk_rf_part4.txt
    source_law: str  # e.g. «ГК РФ»
    article: str     # e.g. «ст.1229»
    clause: str      # e.g. «п.1» (может быть пустым)
